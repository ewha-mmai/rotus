...
# Configuration
MODEL_PATH="${MODEL_PATH:-/workspace/models/Chain-of-Focus/CoF-rl-model-7b}"
TRAIN_DATA="${TRAIN_DATA:-/workspace/data/Dataset/combined_filtered/cof/combined_train_10000.json}"
VAL_DATA="${VAL_DATA:-/workspace/data/Dataset/combined_filtered/cof/combined_val_200.json}"
PROJECT_NAME="${PROJECT_NAME:-cof}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-cof_run}"
TOOL_CONFIG_PATH="${TOOL_CONFIG_PATH:-$(pwd)/examples/grpo_trainer/config/tool_config/cof_zoom_tool_config.yaml}"
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.multi_turn.stop_words='["</answer>", "</tool_call>"]' \
