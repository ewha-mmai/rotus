        ...
        for epoch in range(current_epoch, self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if entropy_for_reward is not None:
                        attach_entropy = getattr(self, "_attach_entropy_signals_to_extra_info", None)
                        if callable(attach_entropy):
                            attach_entropy(batch, entropy_for_reward)
